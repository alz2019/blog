  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="blogApp.album.home.createOrEditLabel" data-cy="AlbumCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? <ValidatedField name="id" required readOnly id="album-id" label="ID" validate={{ required: true }} /> : null}
              <ValidatedField
                label="Title"
                id="album-title"
                name="title"
              ...
              />
              <ValidatedField label="Description" id="album-description" name="description" data-cy="description" type="textarea" />
              <ValidatedField
                label="Created"
                id="album-created"
                name="created"
              ...
              />
              <ValidatedField id="album-user" name="user" data-cy="user" label="User" type="select">
                <option value="" key="0" />
                {users
